...
def render_scoreboard_card(kind: str, home_name: str, away_name: str,
    ...
    if home_penalty is not None or away_penalty is not None:
        ...
        pens_y = row_cy + crest_size[1] / 2 + 24 + name_lines_drawn * 38 + 14
        for pens, cx, is_winner in (
            (home_penalty, crest_x_left + crest_size[0] / 2, pens_won_home),
            (away_penalty, crest_x_right + crest_size[0] / 2, not pens_won_home),
        ):
            if pens is None:
                continue
    ...
    side_y_start = row_cy + crest_size[1] / 2 + 24 + name_lines_drawn * 38 + 20 + pens_block_h
